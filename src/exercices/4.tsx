...
const useUserNamesForm = (): UseUserNamesFormReturnType => {
  ...
  const onSubmit = (event: FormEvent<HTMLFormElement>) => {
    ...
    console.log("User X:", userX); // Log la valeur du champ de saisie pour l'utilisateur X
    console.log("User O:", userO); // Log la valeur du champ de saisie pour l'utilisateur O
    if (!userX || !userO) {
      return;
    }
